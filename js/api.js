...
(function () {
  ...
  var demo = (function () {
    ...
    var claims = [
      ...
      newClaim('RS-1F2G3H', profiles[3], [item('ed-cuphead', 'complete', 1, 1)], 'received', { flagged: true, assignee_id: 'staff-connor', assignee_name: 'Connor Waugaman', claim_notes: [{ body: 'Seller has a prior non-working submission — inspect this one carefully before offering.', author_name: 'Connor Waugaman', created_at: days(1) }], created_at: days(2), claim_history: [h('Claim submitted', null, days(2)), h('Games received at facility', null, days(1))] }) ];
